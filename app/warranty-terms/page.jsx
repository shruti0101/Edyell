...
const page = () => {
  return (
    <div>
      ...
      <section className="mx-auto w-full max-w-[1100px] px-[40px] py-[28px]">
        
        {/* TITLE */}
        <h1 className="font-roboto text-[36px] font-semibold leading-[36px]">
          EDYELL Product Warranty Service Policy
        </h1>

        {/* INTRO */}
        <div className="mt-[18px] space-y-[20px] font-roboto text-[20px] font-normal  text-[#151515] leading-[36px]">
          <p>
            Within the three guarantees validity period, consumers are entitled
            to repair, replacement and return services in accordance with
            relevant regulations. Repair, exchange and return shall be
            processed with the purchase invoice, three guarantees certificate
            or other valid certificates recognized by EDYELL.
          </p>

          <p>
            If consumers lose the invoice and three guarantees certificate,
            but can provide valid evidence such as invoice stub or copy of
            invoice stub to prove that the product is still within the three
            guarantees validity period, EDYELL will provide corresponding
            after-sales services.
          </p>

          <p>
            Other terminal products shall be covered by corresponding warranty
            policies in accordance with relevant national laws. For specific
            policies, please refer to the warranty information of corresponding
            products or call EDYELL official service hotline for further
            details.
          </p>
        </div>
        ...
        <section className="mt-[14px]">
          <h2 className="font-roboto text-[30px] font-semibold leading-[36px]">
            I. Warranty Service Terms
          </h2>

          <ol className="mt-[2px] list-decimal pl-[16px] font-roboto text-[20px] font-normal leading-[36px]">
            <li>
              This service policy only applies to EDYELL products sold through
              official channels in Chinese Mainland. For products sold by
              EDYELL authorized third-party distributors, only in-warranty
              repair service is provided. Please contact the distributor for
              return and exchange services.
            </li>

            <li>
              For non-artificial damage from the original purchase date,
              warranty or replacement service is available with valid warranty
              code and purchase certificate.
            </li>
        ...
        <section className="mt-[12px]">
          <h2 className="font-roboto text-[16px] font-semibold leading-[22px]">
            II. Circumstances Excluded from Free Return, Exchange and Warranty
            Coverage
          </h2>

          <ol className="mt-[2px] list-decimal pl-[16px] font-roboto text-[11px] font-normal leading-[20px]">
